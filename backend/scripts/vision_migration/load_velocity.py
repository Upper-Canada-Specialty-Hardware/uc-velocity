...
# domains (the G1/G2 close-state headline) plus catalog/profile counts, AND the
# invoice tables so the reconstructed-invoice dry-run can report how many invoices
# already exist live (Phase 4). An EXPLICIT short list on purpose -- we never mirror
# the whole app schema.
VELOCITY_TABLES = [
